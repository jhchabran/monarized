...
return function(c, s, cs)
    ...
    local groups = {
        {attributes, c.blue},
        {numbers, c.base1:light(0.10), c.none, s.bold},
        {comments, c.blue:light()},
        {constructors, c.base3, c.none, cs.italic}, -- in C++ variable->constructors() \\ TS docs unclear
        {conditionals, c.base1:light(0.10), c.none},
        {constants, c.base2},
        {defines, c.blue},
        {exceptions, c.blue},
        {fields, c.base1:light(0.10), c.none},
        {functions, c.base2, c.none},
        {includes, c.base2, c.none, s.bold},
        {keywords, c.base2, c.none},
        {labels, c.base3, c.none, cs.italic},
        {namespaces, c.base3, c.none, cs.italic},
        {nones, c.base3},
        {operators, c.base2},
        {parameters, c.base2, c.none, cs.italic},
        {properties, c.base3},
        {punctuations, c.base1:light(0.15)},
        ...
        {texts, c.base2},
        {uris, c.base2},
        {types, c.base1:light(0.10), c.none, s.bold},
        {variables, c.base1:light(0.10)},
        {builtins, c.base1:light(0.10), c.none, cs.italic},
        {notes, c.base2},
        {warnings, c.yellow},
        {dangers, c.yellow},
        {errors, c.red}
